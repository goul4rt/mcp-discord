...
const channelTools: ToolDefinition[] = [
    ...
    },
    {
        ...
        schema: z.object({
            ...
            user_limit: z.number().int().min(0).max(99).optional().describe('Voice channel user limit (0 = unlimited, max 99). Only applies to voice/stage channels.'),
        }),
...
const roleTools: ToolDefinition[] = [
    ...
    },
    {
        ...
        schema: z.object({
            ...
            permissions: permissionFlags.optional().describe('Permission flag names to grant the role'),
